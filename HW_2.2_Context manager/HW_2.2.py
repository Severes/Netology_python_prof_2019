...
Желательно в исходный файл помещать небольшое количество текста, чтобы он умещался в одну строку. Так
будет наглядно видно, какие символы необходимо заменить.
"""
